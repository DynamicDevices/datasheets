# TAS67524-Q1 outputs — pdftotext vs pdf2md (quick comparison)
...
- **Markdown sections**: 13 `.md` files
- **Images**: 30 `.png` files referenced from Markdown
- **Tables**: 16 verbatim table blocks (look for `<!-- VERBATIM_TABLE_START --> ... <!-- VERBATIM_TABLE_END -->`)
...
```bash
DOC_DIR="datasheets/manufacturers/ti/TAS67524-Q1"
