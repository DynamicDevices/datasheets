...
This table presents the measurement results for i.MX 93-11x11-EVK System idle with display on in OD mode with DDRC auto clock gating (average values). The table provides power consumption data across different voltage rails and operating conditions for this specific use case.
