...
The table above shows the hardware and software configuration used for i.MX 93 power measurements. It includes details about the evaluation board, measurement equipment, software tools, and firmware versions used during testing.
...
1. To download and build the i.MX Yocto Project community BSP recipe layers, run the following commands:
   ...
   **Note:** For more information on the i.MX Yocto Project, refer i.MX Yocto Project User's Guide.
   ...
   repo sync
   DISTRO=fsl-imx-xwayland MACHINE=imx93-11x11-lpddr4x-evk source imx-setup-release.sh -b build-imx93-11x11-lpddr4x-evk
   ```
