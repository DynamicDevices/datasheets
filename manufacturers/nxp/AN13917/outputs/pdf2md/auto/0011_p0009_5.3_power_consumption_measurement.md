...
This table maps the power rails monitored in the BCU (Board Controller Unit) software to the corresponding power supply domains in the i.MX 93 processor. The table provides:

- **BCU Rail Names**: The identifier names used in the BCU monitoring software for each power rail
- **Power Supply Domain**: The corresponding domain or functional block in the i.MX 93 processor that each rail powers
- **Mapping Information**: How the BCU measurements correspond to actual processor power domains

This mapping is essential for accurately interpreting power consumption measurements during different use cases and operating modes.
