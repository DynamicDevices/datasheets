...
![Table 26: Measurement results](./images/page_29_table_2.png)

**Table 26. Measurement results for i.MX 93-11x11-EVK_B_System_idle_w_display_on_LD_mode_half_speed_DDR (average value)**

This table displays the power consumption measurement results for the i.MX 93 evaluation board when operating in System Idle mode with display on in LD (Low Drive) mode and DDR running at half speed. The table presents average power consumption values across different power rails and operating conditions for this specific use case configuration.
