...
**Table 8 Description:**
This table presents the measurement results for the Dhrystone loop benchmark running on the i.MX 93-11x11-EVK_B platform. The table displays average power consumption values across different power rails and conditions during the execution of the Dhrystone benchmark with both Cortex-A55 cores active at 1.7 GHz.
