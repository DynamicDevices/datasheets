...
The table image above contains measurement data showing power consumption results for the Dhrystone benchmark running on the i.MX 93 processor. The table provides average values for this specific use case configuration.
