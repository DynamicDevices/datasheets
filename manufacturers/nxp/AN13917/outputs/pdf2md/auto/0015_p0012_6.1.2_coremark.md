...
The table above displays the power consumption measurement results for the CoreMark benchmark running in a continuous loop on the i.MX 93-11x11-EVK board. The measurements represent average values captured during the test execution with the system configured at maximum CPU frequency (1.7 GHz) and DDR data rate (3733 MT/s).
