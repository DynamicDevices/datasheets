...
- LLM_RPS: 0.5
- Workers: 2
- Command: python pdf2md.py -i "/data_drive/dd/pdf2md/datasheets/manufacturers/nxp/AN13917/source/AN13917.pdf" -o "/data_drive/dd/pdf2md/datasheets/manufacturers/nxp/AN13917/outputs/pdf2md/always" -p prompt.txt -w 2 --provider anthropic (with vision=always)
