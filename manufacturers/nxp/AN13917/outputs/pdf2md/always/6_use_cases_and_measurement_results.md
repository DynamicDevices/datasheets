...
| lpd4x_vddq | 0.6 | 0 | 0 | | |
| **GROUP_SOC_FULL** nvcc_1p8 | 1.8 | 0.3 | 0.6 | 805.87 | |
| nvcc_3p3 | 3.3 | 3.6 | 12 | | |
...
| lpd4x_vddq | 0.6 | 0 | 0 | | |
| **GROUP_SOC_FULL** nvcc_1p8 | 1.8 | 0.56 | 1 | 691.85 | |
...
| lpd4x_vddq | 0.6 | 0 | 0 | | |
| **GROUP_SOC_FULL** nvcc_1p8 | 1.8 | 0.28 | 0.5 | 907.97 | |
...
| **GROUP_SOC_FULL** nvcc_1p8 | 1.8 | 0.17 | 0.3 | 913.93 | |
| nvcc_3p3 | 3.3 | 3.7 | 12.3 | | |
| nvcc_bbsm_1p8 | 1.79 | 0.11 | 0.2 | | |
| nvcc_sd2 | 3.3 | 0.9 | 3.1 | | |
...
| lpd4x_vddq | 0.6 | 10 | 6 | | |
| **GROUP_SOC_FULL** nvcc_1p8 | 1.8 | 0.11 | 0.2 | 1222.81 | |
...
| **GROUP_SOC_FULL** nvcc_1p8 | 1.8 | 0.17 | 0.3 | 458.63 | |
...
For this use case, the audio file is a WAV file with a 24 bit and a 32 kHz sample rate. CA55 handles audio decoding, I²S, and audio codec.
...
| **GROUP_SOC_FULL** nvcc_1p8 | 1.8 | 0.22 | 0.4 | 255.39 | |
...
#### Table 15. Measurement results for i.MX 93-11x11-EVK_B_gplay_videoplayback (average value)
...
| **GROUP_SOC_FULL** nvcc_1p8 | 1.79 | 0 | 0.7 | 636.4 | |
...
1. The CPU frequency is set to the maximum value of 1.7 GHz.
2. The DDR data rate is set to 3733 MT/s.
3. The CM33 is in reset hold, waiting for the reset